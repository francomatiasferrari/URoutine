...
public class CargarEjercicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario usu = (Usuario) miSesion.getAttribute("usuarioActual");
        int idUsu = usu.getId();
        ...
        response.sendRedirect("cargarejer.jsp");    
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CargarEjercicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
